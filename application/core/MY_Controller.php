...
class MY_Controller extends CI_Controller {
	...
	function __construct() {
		parent::__construct();
		if (!in_array($this->router->method, $this->public_methods) && !$this->check_auth() && !in_array($this->router->class, array('page', 'auth', 'api'))) {
	 ...
	 */
	function send_email($email_from, $email_from_name, $email_to, $email_subject, $email_message) {
		...
		$this->email->from(($email_from !== '') ? $email_from : $this->config->item('email_from'), ($email_from_name !== '') ? $email_from_name : $this->config->item('email_from_name'));
	 ...
	 */
	function add_email_to_queue($email_from, $email_from_name, $email_to, $users_id, $email_subject, $email_message) {
